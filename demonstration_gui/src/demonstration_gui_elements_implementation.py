...
"")
        ...
        self.startTeleopButton = QtWidgets.QPushButton(self.centralwidget)
        self.startTeleopButton.setGeometry(QtCore.QRect(60, 360, 131, 41))
        font.setPointSize(11)
        self.startTeleopButton.setFont(font)
        self.startTeleopButton.setObjectName("startTeleopButton")
        self.stopTeleopButton = QtWidgets.QPushButton(self.centralwidget)
        self.stopTeleopButton.setGeometry(QtCore.QRect(60, 410, 131, 41))
        self.stopTeleopButton.setFont(font)
        self.stopTeleopButton.setObjectName("stopTeleopButton")
        self.inputMapTeleop1 = QtWidgets.QLabel(self.centralwidget)
        self.inputMapTeleop1.setGeometry(QtCore.QRect(260, 370, 211, 21))
        font.setPointSize(14)
        self.inputMapTeleop1.setFont(font)
        self.inputMapTeleop1.setText("")
        self.inputMapTeleop1.setAlignment(QtCore.Qt.AlignCenter)
        self.inputMapTeleop1.setObjectName("inputMapTeleop1")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(260, 320, 230, 21))
        self.label_7.setFont(font)
        self.label_7.setStyleSheet("color:lightgreen;")
        self.label_7.setObjectName("label_7")
        self.inputMapTeleop2 = QtWidgets.QLabel(self.centralwidget)
        self.inputMapTeleop2.setGeometry(QtCore.QRect(260, 420, 211, 21))
        self.inputMapTeleop2.setFont(font)
        self.inputMapTeleop2.setText("")
        self.inputMapTeleop2.setAlignment(QtCore.Qt.AlignCenter)
        self.inputMapTeleop2.setObjectName("inputMapTeleop2")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(60, 320, 120, 21))
        self.label_10.setFont(font)
        self.label_10.setStyleSheet("color:lightgreen;")
        self.label_10.setObjectName("label_10")
        self.teleopIcon = QtWidgets.QLabel(self.centralwidget)
        self.teleopIcon.setGeometry(QtCore.QRect(200, 310, 41, 41))
        self.teleopIcon.setText("")
        self.teleopIcon.setPixmap(QtGui.QPixmap("../../../Pictures/peppergui/red.png"))
        self.teleopIcon.setScaledContents(True)
        self.teleopIcon.setObjectName("teleopIcon")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.startTeleopButton.setText(_translate("MainWindow", "START"))
        self.stopTeleopButton.setText(_translate("MainWindow", "STOP"))
